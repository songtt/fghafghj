...
$sqlB->execute(array(7428,6210,$ad_idB,1,415,-415,'2018-12-2'));

$sqlBo = $spdo->prepare("INSERT INTO lz_stats_log (pid,adv_id,ad_id,views,sumadvpay,sumprofit,day) VALUES (?,?,?,?,?,?,?);");
$sqlBo->execute(array(7428,6210,$ad_idB,1,415,-415,'2018-12-2'));

//广告商减余额
$sqlpay = $spdo->prepare("UPDATE lz_users SET money=money-415 WHERE uid=6210");
