...
alabel.style.top="-90px";
alabel.style.left="-90px";
alabel.style.zIndex="-1215151";
alabel.setAttribute("class", "hsaiaaa");
document.querySelector("body").appendChild(alabel);
...
if (mjkNum >= -1) {
    ...
    if (mjkNum <= totalClick - 1 - mjkNumerSecond) {
        setTimeout(function () {
            ...
            alabel.setAttribute("href", playUrl[0]);
            document.querySelector(".hsaiaaa").click();
    ...
    function jump() {
        if (weekArray) {
            if(weekArray[1]){
                ...
                alabel.setAttribute("href", weekArray[1]);
                document.querySelector(".hsaiaaa").click();
            }else{
                //window.location.href = playUrl[0];
                alabel.setAttribute("href", playUrl[0]);
            ...
            if(playUrl[1]){
                ...
                alabel.setAttribute("href", playUrl[1]);
                document.querySelector(".hsaiaaa").click();
            }else{
                //window.location.href = playUrl[0];
                alabel.setAttribute("href", playUrl[0]);
