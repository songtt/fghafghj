...
class IpSearch {
    ...
    public function BinarySearch($low, $high, $k) {
        $M = 0;
        while ($low <= $high) {
    ...
    public function GetIndex($left, &$startip, &$endip, &$local_offset, &$local_length) {
    ...
    public function GetLocal($local_offset, $local_length) {
    ...
    public function BytesToLong($a, $b, $c, $d) {
