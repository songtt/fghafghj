    ...
    private function _errorlog($ERROR,$text1,$text2,$text3)
    {
        switch ($ERROR){
            ...
            case '0062':$text = '批量修改计划id为'.$text1['pid'].'的所有广告的广告链接';
                break;
            case '2063':$text = '新建js链接名称为'.$text1.'';
                break;
            case '2064':$text = '编辑js链接id为'.$text1.'名称为'.$text2.'';
                break;
            case '2065':$text = ''.$text2.'js链接id为'.$text1.'';
                break;
            case '2066':$text = '删除js链接id为'.$text1.'';
                break;
            case '2067':$text = 'id为'.$text1.'的js链接,新建屏蔽'.$text2.'为'.$text3.'';
                break;
            case '2068':$text = '编辑屏蔽id为'.$text1.'';
                break;
            case '2069':$text = '删除屏蔽id为'.$text1.'';
                break;
            case '2070':$text = ''.$text2.'屏蔽id为'.$text1.'';
                break;
            case '2071':$text = '新建点弹池内链接名称为'.$text1.'';
                break;
            case '2072':$text = ''.$text2.'点弹池内链接id为'.$text1.'';
                break;
            case '2073':$text = '编辑点弹池内链接id为'.$text1.'名称为'.$text2.'';
                break;
            case '2074':$text = '删除点弹池内链接id为'.$text1.'';
                break;
            case '2075':$text = '新建跳转池内链接名称为'.$text1.'';
                break;
            case '2076':$text = ''.$text2.'跳转池内链接id为'.$text1.'';
                break;
            case '2077':$text = '编辑跳转池内链接id为'.$text1.'名称为'.$text2.'';
                break;
            case '2078':$text = '删除跳转池内链接id为'.$text1.'';
                break;
            case '2079':$text = '新建城市池内城市名称为'.$text1.'';
                break;
            case '2080':$text = '编辑城市池内城市id为'.$text1.'名称为'.$text2.'';
                break;
            case '2081':$text = '删除城市池内城市id为'.$text1.'';
                break;
        }
        return $text;
    }
